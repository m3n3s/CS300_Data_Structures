...
void HashTable<Key, Value>::rehash()
{
	...
	cout << "previous table size: " << myArray.size();
	...
	cout << ", new table size: " << myArray.size() <<  ", current unique word count " << currentSize;
	cout << ", current load factor: " << load << endl << "rehashed..." << endl;
}
